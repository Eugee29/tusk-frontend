...
export function BoardPreview({ board, onUpdateBoard }) {
   ...
   return (
      <li className="board-section-list-item">
         <div className="board-tile" style={{ backgroundImage: `url(${board.style.bgImg})` }} >
            ...
            <div className="board-tile-details">
               ...
               <div className="board-tile-details-sub-container">
                  <span className="board-tile-options" onClick={() => { onStarred() }}>
                     ...
                     {board.isStarred && <svg stroke="currentColor" fill="currentColor" strokeW sidth="0" viewBox="0 0 1024 1024" className="star-icon starred" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
