...
export function BoardPreview({ board, onUpdateBoard }) {
   ...
   // const [linkTo, setLinkTo] = useState(`/board/${board._id}`)
   ...
   return (
      <li className="boards-page-board-section-list-item">
         <div className="board-tile" /*to={linkTo}*/ style={{ backgroundImage: `url(${board.style.bgImg})` }} >
            <span className="board-tile-fade"></span>
            <div className="board-tile-details">
               <div className="board-tile-details-name" onClick={() => { onclicked() }}>
                  {board.title}
               </div>
               ...
               <div className="board-tile-details-sub-container">
                  <span className="board-tile-options" onClick={() => { onStarred() }}>
                     ...
                     {board.isStarred && <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" className="star-icon starred" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
